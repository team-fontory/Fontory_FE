...
export const Footer = () => {
  return (
    <footer className='bg-accent px-10 py-8' aria-label='사이트 푸터'>
      <div className='flex-column mx-auto max-w-7xl gap-12' aria-label='사이트 푸터'>
        <div className='flex-between'>
          ...
          <div className='flex gap-10'>
            <nav aria-label='사이트 네비게이션'>
              <h3 className='mb-4 text-center text-sm font-semibold text-white'>LINKS</h3>
            ...
            <nav aria-label='약관 및 정책'>
              <h3 className='mb-4 text-center text-sm font-semibold text-white'>POLICY</h3>
              <ul className='flex-column text-footer-description items-center gap-3 text-sm'>
